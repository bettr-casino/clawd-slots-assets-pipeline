...
- **Fallback extraction path**: If default path fails/low quality, run `/workspaces/clawd-slots-assets-pipeline/scripts/extract_symbol_boundaries.py` for CV-based symbol crops
