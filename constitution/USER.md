...
- For regeneration, use annotation-first extraction from approved frame annotation JSON files.
- Do not switch to detector pipelines automatically; if annotation files are missing or quality is poor, pause and ask for human decision.
